...
;// CONCATENATED MODULE: ./src/images/stations/station_pages/sokol_img01.png
const sokol_img01_namespaceObject = __webpack_require__.p + "images/94d217b92654ff095b73.png";
;// CONCATENATED MODULE: ./src/images/stations/station_pages/sokol_img02.jpeg
const sokol_img02_namespaceObject = __webpack_require__.p + "images/3d8d786934db4826abf8.jpeg";
;// CONCATENATED MODULE: ./src/images/stations/station_pages/sokol_img03.jpeg
const sokol_img03_namespaceObject = __webpack_require__.p + "images/d4696b0936a07d59fdc3.jpeg";
;// CONCATENATED MODULE: ./src/images/stations/station_pages/sokolHeading.png
const sokolHeading_namespaceObject = __webpack_require__.p + "images/d3f4ac7d020052d0f458.png";
...
;// CONCATENATED MODULE: ./src/javascript/pages/sokolniki.js
...
root.render( /*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(menu, {
  ...
  BGUrl: sokolHeading_namespaceObject,
  station: 'Сокольники',
  line: 'Сокольническая'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  text: 'Станция "Сокольники" — одна из самых знаковых станций московского метро. Она не только является важным транспортным узлом, но и отражает богатую историю и уникальную архитектуру. Давайте поближе познакомимся с этой легендарной станцией!'
}), /*#__PURE__*/react.createElement(Q_Image, {
  width: 9,
  height: 40,
  margin: 5,
  url: sokol_img01_namespaceObject
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'История',
  text: 'Станция "Сокольники" открылась 15 мая 1935 года, став одной из первых станций московского метрополитена. Её название происходит от исторического района Сокольники, где раньше проводились царские соколиные охоты. С момента своего открытия "Сокольники" играет ключевую роль в транспортной системе Москвы, соединяя центр города с северо-восточными районами.'
}), /*#__PURE__*/react.createElement(Q_Image, {
  width: 12,
  height: 40,
  margin: 4,
  url: sokol_img02_namespaceObject
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Архитектура',
  ...
  text: 'За время своего существования станция "Сокольники" неоднократно реконструировалась и обновлялась. Последняя масштабная реконструкция прошла в 2020 году, в ходе которой были обновлены отделочные материалы, установлено современное освещение и улучшены условия для пассажиров с ограниченными возможностями.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Значение',
  text: 'Сегодня "Сокольники" — это не только исторический памятник, но и важный транспортный узел, ежедневно обслуживающий тысячи пассажиров. Станция соединяет центр Москвы с окраинами, обеспечивая быстрый и удобный доступ к различным районам города. '
}), /*#__PURE__*/react.createElement(Q_Image, {
  width: 12,
  height: 40,
  margin: 4,
  url: sokol_img03_namespaceObject
