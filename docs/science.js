...
;// CONCATENATED MODULE: ./src/images/articles/news_pages/science_img01.png
const science_img01_namespaceObject = __webpack_require__.p + "images/f3b304db5339dc827350.png";
;// CONCATENATED MODULE: ./src/javascript/pages/science.js
...
root.render( /*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(menu, {
  ...
  station: '🧠 Научные конференции в метро Москвы: подземные встречи для умников 🚇✨ '
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  text: 'Московское метро становится необычной площадкой для научных конференций, привлекая ученых со всего мира. Станции, такие как "Парк культуры", "Кропоткинская" и "ВДНХ", превращаются в залы для выступлений и обсуждений, создавая уникальную атмосферу.'
}), /*#__PURE__*/react.createElement(Q_Image, {
  width: 10,
  height: 40,
  margin: 5,
  url: science_img01_namespaceObject
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  text: 'Темы варьируются от урбанистики и транспортных технологий до экологии и космоса. Участвуют ведущие ученые, исследователи и студенты, что делает конференции динамичными и живыми. Главная цель – популяризация науки и поиск новых решений для актуальных проблем. Следите за афишами и присоединяйтесь к подземным научным встречам! 🧠🚇✨'
