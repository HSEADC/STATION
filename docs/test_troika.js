...
;// CONCATENATED MODULE: ./src/javascript/pages/test_troika.js
...
root.render( /*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(menu, {
  ...
  text: 'Теперь вы можете активировать онлайн-пополнение «Тройки» и карты москвича на самих турникетах метро и МЦК. Больше не нужно искать желтые терминалы. '
}), /*#__PURE__*/react.createElement(Q_Image, {
  width: 10,
  height: 40,
  margin: 5,
  url: test_troika_img01_namespaceObject
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  text: '«Сервис доступен для всех выпущенных «Троек» и карт москвича для обучающихся. Возможность активировать баланс карты на турникете — одна из самых долгожданных цифровых новинок. Сервис позволит экономить до 20 минут в месяц для 2 млн пассажиров. Мы продолжим совершенствовать билетную систему и делать ее еще удобнее по поручению Мэра Москвы Сергея Собянина», — отметил Максим Ликсутов. '
