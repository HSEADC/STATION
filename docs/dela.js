...
;// CONCATENATED MODULE: ./src/javascript/pages/dela.js
...
root.render( /*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(menu, {
  ...
  description: 'С 22 июня 2024 года временно закрылся участок «Деловой центр — Шелепиха — Хорошёвская» БКЛ для интеграции в Рублёво-Архангельскую линию. Откроется он уже в составе новой линии.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  text: 'Не переживайте! «Москва-Сити» и «Деловой центр» — крупнейшие транспортные хабы, поэтому у вас будет много вариантов для поездок: через филевскаую линию, солнцевскую линию, МЦД-1 и МЦД-4, а также регулярные маршруты наземного транспорта, проходящие через «Шелепиху», станут ходить чаще. 🚌✨'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  text: 'Все изменения и ограничения сразу отображаются на карте в приложении «Метро Москвы», чтобы вы могли лучше спланировать новые варианты маршрута! 🗺📱 Так что CHECK IT, чтобы быть в курсе последних обновлений и удобно ориентироваться 🚇✨'
