...
;// CONCATENATED MODULE: ./src/images/articles/news_pages/newtrainsHeading.png
const newtrainsHeading_namespaceObject = __webpack_require__.p + "images/493d4c2063300d48c36a.png";
;// CONCATENATED MODULE: ./src/images/articles/news_pages/newtrains_img01.png
const newtrains_img01_namespaceObject = __webpack_require__.p + "images/747efae570df5902084b.png";
...
;// CONCATENATED MODULE: ./src/javascript/pages/new_trains.js
...
root.render( /*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(menu, {
  ...
  BGUrl: newtrainsHeading_namespaceObject,
  ...
  heading: 'Когда? Как?',
  text: 'Одна из самых старых веток метро Москвы наконец-то обзаведется обновками. Уже в начале 2024 года в тестовом режиме на ветке запустят новые поезда “Москва - 2020”, а к концу года планируется заменить 100% составов. '
}), /*#__PURE__*/react.createElement(Q_Image, {
  width: 14,
  height: 40,
  margin: 4,
  url: newtrains_img01_namespaceObject
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  text: 'В новых вагонах изменится расположение USB-розеток, они появятся на поручнях для удобной зарядки стоя, двери останутся все такими же широкими, как в последних обновлениях составов на Калужско-Рижской, Кольцевой и Большой кольцевой линии.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  text: 'В электродепо «Сокол» Замоскворецкой линии начинает работу сервисный центр от производителя вагонов метро — «Метровагонмаша». Он будет обслуживать новые поезда по контракту жизненного цикла в течение всего срока их эксплуатации.'
