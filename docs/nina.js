...
;// CONCATENATED MODULE: ./src/javascript/pages/nina.js
...
root.render( /*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(menu, {
  ...
  description: 'Московский метрополитен – это не только инженерное чудо, но и настоящее произведение искусства. Одним из главных его создателей была Нина Алёшина, архитектор, которая внесла неоценимый вклад в создание подземных шедевров. Давайте поближе познакомимся с этой удивительной женщиной.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Кто такая Нина Алёшина?',
  text: 'Нина Александровна Алёшина – выдающийся советский и российский архитектор. Она родилась в 1924 году и с ранних лет проявляла интерес к искусству и архитектуре. Окончив Московский архитектурный институт, Нина начала свою карьеру в Метрогипротрансе – институте, занимающемся проектированием метрополитенов.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Её вклад в метро',
  text: 'За свою карьеру Нина Алёшина спроектировала множество станций московского метро, каждая из которых является настоящим произведением искусства. Вот несколько самых известных её работ:'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Станция "Киевская" (1954)',
  text: 'Украшенная мозаиками и мрамором, она напоминает о дружбе народов и является одной из самых красивых станций.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Станция "Калужская" (1964)',
  text: 'Современная и функциональная, она стала образцом для станций нового поколения.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Станция "Белорусская" (1952)',
  text: 'Элегантные колонны и резные элементы делают её одной из самых узнаваемых станций в Москве.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Почему её называют матерью метро?',
  text: 'Нина Алёшина посвятила свою жизнь созданию метро, которое не только функционально, но и красиво. Её работы отличает внимание к деталям, использование качественных материалов и глубокое понимание того, что метро должно быть не только транспортным средством, но и культурным пространством. Благодаря её таланту и труду московский метрополитен стал тем, чем он является сегодня – гордостью города и примером для подражания.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Наследие',
  text: 'Наследие Нины Алёшиной живет и по сей день. Станции, созданные её руками, ежедневно встречают и провожают тысячи пассажиров. Они напоминают нам о том, что метро – это не просто подземный транспорт, а целый мир, наполненный красотой и историей.Так что, когда в следующий раз будешь на одной из этих станций, остановись на минуту и полюбуйся вокруг. Это не просто стены и потолки – это искусство, созданное великой женщиной. 🌟'
