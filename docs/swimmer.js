...
;// CONCATENATED MODULE: ./src/javascript/pages/swimmer.js
...
root.render( /*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(menu, {
  ...
  description: '💡 Вопрос к знатокам метрополитена: что такое плывуны и почему они могут быть проблемой для метро? 🚇🌊'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: '"Метро" (2013)',
  text: 'Плывуны – это такие участки земли, которые насыщены водой до такой степени, что превращаются в неустойчивую кашу. Представь себе гигантское болото, только под землёй! 🌿💦 Они могут быть очень коварными для строительства и эксплуатации метро. Почему это проблема? 🤔'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Потоп и провал:',
  text: 'Плывуны могут вызвать внезапные затопления или даже провалы грунта. Представь, что туннель начинает буквально "плыть" – не самая приятная картина!'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Сложности в строительстве:',
  text: 'Возведение тоннелей через плывуны требует специальных технологий и материалов. Это дольше, дороже и сложнее, чем обычные земляные работы.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  ...
  text: 'Уже построенные тоннели и станции могут подвергаться дополнительным рискам из-за движения и деформации грунта. Это требует постоянного мониторинга и возможных ремонтных работ.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  text: 'Но не стоит паниковать! 🚧 Московский метрополитен активно работает над решением этих проблем. Специалисты используют современные технологии и материалы, чтобы защитить тоннели и станции от плывунов.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  text: 'Так что, если ты услышишь о плывунах, знай: это не просто жуткая история для городских легенд, а реальная инженерная задача, которую успешно решают профессионалы. 💪🔧'
