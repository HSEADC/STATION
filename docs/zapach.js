...
;// CONCATENATED MODULE: ./src/images/articles/news_pages/test_troika_img01.png
const test_troika_img01_namespaceObject = __webpack_require__.p + "images/d0f9a5dbc04260ad0776.png";
;// CONCATENATED MODULE: ./src/javascript/pages/zapach.js
...
root.render( /*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(menu, {
  ...
  description: 'Московский метрополитен вводит инновацию: теперь пассажиры смогут выбирать ароматы для новых веток метро! Этот проект направлен на улучшение комфорта и создания приятной атмосферы в подземке. На выбор предлагаются несколько ароматов, каждый из которых создаст особое настроение.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Голосование',
  text: 'Жители Москвы активно участвуют в голосовании, проходящем в приложении "Метро Москвы". Пассажиры могут выбрать из нескольких вариантов, таких как: свежесть леса, цветочный букет, цитрусовая свежесть, морской бриз, легкая лаванда. '
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Результаты',
  text: 'Итоги голосования будут объявлены в конце месяца, и самые популярные ароматы начнут использоваться на новых станциях уже в следующем году. Это не только сделает поездки более приятными, но и поможет создать уникальную атмосферу на каждой линии.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Технология ',
  text: 'Для внедрения ароматов используются современные системы вентиляции и ароматизации, которые обеспечат равномерное и ненавязчивое распространение запахов. Особое внимание уделяется безопасности и комфорту пассажиров. '
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  text: 'Так что не упустите возможность повлиять на будущее метро и проголосуйте за любимый аромат! Сделаем наши поездки еще более приятными и комфортными вместе! 🌸🚇✨'
