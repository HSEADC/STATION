...
;// CONCATENATED MODULE: ./src/javascript/pages/cinema.js
...
root.render( /*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(menu, {
  ...
  station: '🎬 Метро Москвы на большом экране: киношные приключения под землей 🚇🍿 ',
  description: 'Московское метро – не просто транспортная система, а настоящая кинозвезда! Оно уже давно стало излюбленным местом для съемок фильмов. Давай вспомним несколько классных примеров:'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: '"Метро" (2013)',
  text: 'Этот фильм наверняка попадался тебе на глаза. Захватывающий сюжет о катастрофе, где один из туннелей затопило, и пассажирам приходится бороться за свою жизнь. Мощные спецэффекты и напряженная атмосфера – на грани реальности!'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: '"Ночной дозор" (2004)',
  text: 'Культовая российская картина, где сцены в метро играют важную роль. Мрачные коридоры и загадочные персонажи создают атмосферу мистики и напряжения.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: '"Время первых" (2017)',
  text: 'Хотя фильм в основном о космосе, в нем есть эпизоды, связанные с метро. Московское метро здесь – символ прогресса и силы, как и сами космонавты.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: '"Анна Каренина" (2012)',
  text: 'Современная версия классического романа. В фильме использованы станции московского метро, чтобы передать атмосферу богатства и элегантности.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: '"Дневной дозор" (2006)',
  text: 'Продолжение "Ночного дозора". Опять-таки, сцены в метро здесь играют важную роль в создании напряженной и мрачной атмосферы.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  text: 'Московское метро – это больше, чем просто транспорт. Его уникальная архитектура и атмосфера делают его идеальным местом для съемок. От напряженных триллеров до мистических историй, метро Москвы помогает создавать незабываемые кадры и сцены, которые надолго остаются в памяти зрителей.'
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  text: 'Так что в следующий раз, когда будешь смотреть фильм, обрати внимание на знакомые станции и туннели. Может быть, ты увидишь московское метро в совершенно новом свете! 🎥✨'
