...
;// CONCATENATED MODULE: ./src/images/articles/news_pages/troikaHeading.png
const troikaHeading_namespaceObject = __webpack_require__.p + "images/59c78f642c453fc225c6.png";
;// CONCATENATED MODULE: ./src/images/articles/news_pages/troika_img01.png
const troika_img01_namespaceObject = __webpack_require__.p + "images/5fdf32fed2aa074d1855.png";
;// CONCATENATED MODULE: ./src/images/articles/news_pages/troika_img02.png
const troika_img02_namespaceObject = __webpack_require__.p + "images/4cd3cd5972d9691231d7.png";
;// CONCATENATED MODULE: ./src/images/articles/news_pages/troika_img03.png
const troika_img03_namespaceObject = __webpack_require__.p + "images/9a90fda8714e53a80491.png";
;// CONCATENATED MODULE: ./src/images/articles/news_pages/troika_img04.png
const troika_img04_namespaceObject = __webpack_require__.p + "images/44376c5eae60660c1c7a.png";
...
;// CONCATENATED MODULE: ./src/javascript/pages/troika.js
...
root.render( /*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(menu, {
  ...
  BGUrl: troikaHeading_namespaceObject,
  station: 'Тройка — просто пластиковая карта или что-то поинтереснее?  ',
  description: 'Тройка и так очень удобный способ оплаты: можно записать, как и тарифный план, так и просто положить деньги. Положить ее можно под чехол телефона, в чехол, в картхолдер или хоть под шапку и ежедневно удивлять прохожих оплтой проезда поклоном перед турникетами. Однако, пластиковая карта — не единственный вариант тройки, который предлагает Мосметро. '
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Брелок',
  text: 'Если положить Тройку в картхолдер ко всем своим картам, то приложить кратхолдер — не прокатит, а то вдруг оплатит банковской картой. А вот повесить Тройку на ключи было бы очень удобно — ключи от дома же не откроют турникеты. '
}), /*#__PURE__*/react.createElement(Q_Image, {
  width: 13,
  height: 40,
  margin: 5,
  url: troika_img01_namespaceObject
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  text: 'Официальный магазин Метро Москвы предлагает как и классический варинт с тройцей лошадей, так и изображения в коллаборации с центром поддержи краснокнижных животных России. '
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Попсокеты',
  text: 'Если место под карточку в чехле у вас уже занято, то есть и другой варинт нацепить всё на телефон — попсокет Тройка. Иет в белом и черном цвете и только с лошадками.'
}), /*#__PURE__*/react.createElement(Q_Image, {
  width: 13,
  height: 40,
  margin: 5,
  url: troika_img02_namespaceObject
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Браслеты',
  text: 'Если вы вообще не хотите доставать ничего из карманов, то перед выходом из дома можно надеть силиконовый браслет Тройку в одном из четырех цветов веток метро: Замоскворецкой, Люблинско-Дмитровской, Некрасовской или Арбатско-Покровской'
}), /*#__PURE__*/react.createElement(Q_Image, {
  width: 13,
  height: 40,
  margin: 5,
  url: troika_img03_namespaceObject
}), /*#__PURE__*/react.createElement(ArticleChapter, {
  heading: 'Кольца',
  text: 'А как раз в придверии зимы, когда любой браслет окажется под толстым слоем одежды и куртки, МосМетро выпустили лимитирвоанную коллекцию Троек колец в трех разцветках: белой, розовой и черной. Под любой лук и настроение. Работает и через перчатки и через варежки, редакция проверила.'
}), /*#__PURE__*/react.createElement(Q_Image, {
  width: 4,
  height: 40,
  margin: 5,
  url: troika_img04_namespaceObject
